...
import FixedDataTable2 from "../../app/components/DataGrid/FixedDataTable2";

describe("Data Grids", () => {
	describe("<FixedDataTable2/>", () => {
		const props = {
			dataLoad: function(){},
	    	...
	    	for(var edit=0; edit<2; edit++){
	    		for(var rowSortDesc=0; rowSortDesc<2; rowSortDesc++){
	    			for(var reorderableColumns=0; reorderableColumns<2; reorderableColumns++){
	    				...
	    				var connectedApp = ReactDOM.render(<FixedDataTable2 {...propVariant}/>, container);
