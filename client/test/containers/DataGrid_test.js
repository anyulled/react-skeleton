...
import FixedDataTable2Container from "../../app/containers/DataGrid/FixedDataTable2Container";
...
describe("Data Grids", () => {
	...
	afterEach(function(){
		...
		describe("<FixedDataTable2Container />", () => {
		it("should mount", function () {  	
			let connectedApp = ReactDOM.render(<FixedDataTable2Container {...props} store={store}/>, container);
