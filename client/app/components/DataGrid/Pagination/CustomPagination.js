    ...
    render() {
        ...
        return(
            <div style={{width:100+"%","backgroundImage":"linear-gradient(#fff,#efefef)","border": "1px solid #d3d3d3","padding":"7px 2px 3px"}}>
                <Grid fluid>
                    <Row>
                        <Col xs={9} sm={10} style={{"paddingLeft":"3px"}}>
                            <Pagination
                                prev
                                next
                                first
                        ...
                        <Col xs={3} sm={2} style={{"borderLeft":"1px solid rgb(211, 211, 211)","minHeight":"30px","padding":"13px 2px 2px 14px"}}>
                            <div style={{"border":"1px solid #d3d3d3","padding":"5px 2px","margin":"1px 0px","border-radius":"3px","border-color":"rgb(209,217,222)","color":"#1d769f"}}>
