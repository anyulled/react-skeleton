...
class FilterBar extends React.Component {
	...
	render() {
		...
		let self=this;
		return (
		    <div style={{width:100+'%',"backgroundImage":"linear-gradient(#fff,#efefef)","border": "1px solid #d3d3d3","borderBottom": "0px"}}>
			    <Grid fluid>
				    <Row>
			    		<Col xs={3} md={2}>
			    			Filters
			    		...
			    		<Col xs={9} md={10}>
				    		<Grid fluid>
					    		...
					    		{filters?filters.map(function (filter, i) {
						    			return (		    					
						    					<Col xs={6} md={4} >
								    			<FilterContainer key={i} filterType={filter.type} filterProps={filter}/>	</Col>	    					
						    			);
					                }):null}	
				    			</Row>
						    </Grid>	 
